...
TEST(MergeSortTest, HandlesEmptyArray) {
  ...
  const MergeSort sorter(arr, size);
  sorter.sort();
...
TEST(MergeSortTest, HandlesReversedArray) {
  int arr[] = {5, 4, 3, 2, 1};
  constexpr int size = 5;
...
TEST(MergeSortTest, HandlesArrayWithDuplicates) {
...
TEST(MergeSortTest, HandlesArrayWithNegativeNumbers) {
